...
export const Mywork = () => {
  ...
  return (
    <section className="mx-auto px-6 py-8 sm:py-12 max-w-7xl" id="my-work">
      ...
      <div className="grid md:grid-cols-2 gap-y-10 gap-x-20 lg:gap-x-40 xl:gap-x-56 items-center py-16 sm:py-24">
        <div>
          <h3 className="text-2xl sm:text-4xl max-w-sm">
            Blade Runner Mock-up Score
          </h3>
          <p className="font-sans text-base opacity-80 mt-8 sm:mt-16">
